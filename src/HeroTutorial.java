...
//      Argument constructor
        Hero hero1 = new Hero("Artjoms","Petrovs","AliExpressman", 1234567, Hero.HeroType.Hero,35);
        Hero hero2 = new Hero("Artjoms","Petrovs","Ironman", 987654321, Hero.HeroType.Hero,35);

//      Or other option - non-argument constructor:
        Hero hero3 = new Hero();
        hero3.setName("Artjoms");
        hero3.setSurname("Petrovs");
        hero3.setDeedTime(1);
        hero3.setNickname("Dr Evil");
        hero3.setHeroType(Hero.HeroType.Villain);
